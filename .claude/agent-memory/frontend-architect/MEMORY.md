# Frontend Architect Memory Index

- [Project Overview](project_overview.md) — Bondly app: stack, base URL, dark theme, auth module status
- [Screens & Routes](screens_routes.md) — Completed screens and their GoRouter routes
